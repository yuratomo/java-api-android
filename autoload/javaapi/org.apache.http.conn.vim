...
call javaapi#class('ConnectTimeoutException', '', [
...
call javaapi#class('EofSensorInputStream', '', [
...
call javaapi#interface('OperatedClientConnection', '', [
...
call javaapi#class('HttpHostConnectException', '', [
...
call javaapi#interface('ManagedClientConnection', '', [
  \ javaapi#method(0,'isSecure(', ')', 'boolean'),
