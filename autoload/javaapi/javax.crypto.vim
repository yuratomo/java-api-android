...
call javaapi#class('CipherOutputStream', '', [
...
call javaapi#class('ShortBufferException', '', [
...
call javaapi#class('CipherInputStream', '', [
...
call javaapi#class('IllegalBlockSizeException', '', [
...
call javaapi#class('ExemptionMechanismException', '', [
