...
call javaapi#interface('HttpClientConnection', '', [
...
call javaapi#interface('HeaderIterator', '', [
  \ javaapi#method(0,'hasNext(', ')', 'boolean'),
  \ javaapi#method(0,'nextHeader(', ')', 'Header'),
  \ ])

call javaapi#interface('HttpInetConnection', '', [
...
call javaapi#class('MethodNotSupportedException', '', [
...
call javaapi#class('HttpVersion', '', [
...
call javaapi#interface('HttpRequest', '', [
...
call javaapi#class('ConnectionClosedException', '', [
...
call javaapi#class('NoHttpResponseException', '', [
  \ javaapi#method(0,'NoHttpResponseException(', 'String)', 'public'),
  \ ])

call javaapi#class('MalformedChunkCodingException', '', [
...
call javaapi#interface('HttpResponse', '', [
...
call javaapi#interface('HttpServerConnection', '', [
...
call javaapi#interface('HeaderElementIterator', '', [
  \ javaapi#method(0,'hasNext(', ')', 'boolean'),
...
call javaapi#interface('FormattedHeader', '', [
  \ javaapi#method(0,'getBuffer(', ')', 'CharArrayBuffer'),
  \ javaapi#method(0,'getValuePos(', ')', 'int'),
  \ ])

call javaapi#interface('TokenIterator', '', [
  \ javaapi#method(0,'hasNext(', ')', 'boolean'),
